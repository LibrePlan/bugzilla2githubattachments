...
import org.libreplan.business.costcategories.entities.PredefinedTypeOfWorkHours;
...
public class ConfigurationTypeOfWorkHoursBootstrap implements
    ...
    public void loadRequiredData() {
        ...
        // specified by PredefinedTypeOfWorkHours if there isn't any
        // TypeOfWorkHours in the database
        TypeOfWorkHours typeOfWorkHours;
        try {
		
        /*Modified by DITRUONG BRED-IT THAILAND 29-AUG-2013
		 * Should get PredefinedTypeOfWorkHours instead of PredefinedWorkReportTypes
			typeOfWorkHours = typeOfWorkHoursDAO
                    .findUniqueByName(PredefinedWorkReportTypes.DEFAULT
                            .getName());
		 */
		typeOfWorkHours = typeOfWorkHoursDAO
                    .findUniqueByName(PredefinedTypeOfWorkHours.DEFAULT.getTypeOfWorkHours().getName());
